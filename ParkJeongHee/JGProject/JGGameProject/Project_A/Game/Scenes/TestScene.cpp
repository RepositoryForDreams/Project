...
bool TestScene::init()
{
    ...
    auto mSprite = Sprite::create("HelloWorld.png");
    if (mSprite == nullptr)
    {
...
void TestScene::update(float delta)
{
	...
	{
        is_run = true;
        auto moveBy = MoveBy::create(1.0f, { 10.0,0.0 });
        mSprite->runAction(moveBy);
	}
    else
    {
        mSprite=  static_cast<Sprite*>(getChildByTag(500));
    }
