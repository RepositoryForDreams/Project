...
namespace JG
{
	...
	//{
	//	u64 originBtSize = mElementSize;
	//	mElementSize = elementSize; 
	//	u64 btSize = mElementSize;
	...
	//			auto commandList = DirectX12API::GetCopyCommandList();
	//			commandList->CopyBuffer(mD3DResource.Get(), datas, elementSize, 1);
	//		}
	//	}
	//	break;
	//	case EBufferLoadMethod::CPULoad:
	...
	//	}
	//}
	//SharedPtr<DirectX12ConstantBuffer> DirectX12ConstantBuffer::Create(const String& name, EBufferLoadMethod method)
	//{
	//	auto buffer = CreateSharedPtr<DirectX12ConstantBuffer>();
	//	buffer->SetName(name);
	//	buffer->SetBufferLoadMethod(method);
	...
	//SharedPtr<DirectX12StructuredBuffer> DirectX12StructuredBuffer::Create(const String& name, EBufferLoadMethod method)
	//{
	//	auto buffer = CreateSharedPtr<DirectX12StructuredBuffer>();
	//	buffer->SetName(name);
	//	buffer->SetBufferLoadMethod(method);
	//	return buffer;
	//}
