...
namespace JG
{
	...
	private:
		...
		std::map<i32, i32>       mRootParamInitTypeMap;
		std::map<i32, CPUCache>	 mCPUCache;
		std::map<u32, D3D12_DESCRIPTOR_RANGE_TYPE> mDescriptorTableType;
	...
	public:
		...
		void CommitDescriptorTable(u32 rootParam, const std::vector<D3D12_CPU_DESCRIPTOR_HANDLE>& handles);
